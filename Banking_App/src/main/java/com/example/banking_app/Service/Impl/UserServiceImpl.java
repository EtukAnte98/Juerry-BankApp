...
public class UserServiceImpl implements UserService {
    ...
    public BankResponse createAccount(UserRequest userRequest) {
        ...
        //Also, check if the user already has an account
    ...
    public BankResponse transfer(TransferRequest request) {
        ...
        //check if the amount you are debiting is not more than the current balance
        //debit the account
        ...
        EmailDetails debitAlert = EmailDetails.builder()
                ...
                .messageBody("The sum of " + request.getAmount() + "has been deducted from your current balance is " + sourceAccountUser.getAccountBalance())
                .build();
